...
const Navbar = () => {
  ...
  return (
    <>
      <header className='sticky top-0 z-50 bg-gray-950/95 backdrop-blur-md text-white shadow-2xl shadow-gray-950/95 border-b border-orange-900'>
      <div className="container mx-auto px-4 py-4 flex justify-between items-center">
        <Link to={'/'}>
        <div className='flex items-center space-x-3 cursor-pointer'>
          <House  className='w-8 h-8 text-orange-400 drop-shadow-lg'/>
          <h1 className='text-4xl font-extrabold tracking-widest uppercase'>ELECTRONICS<span className='text-orange-400'>STORE</span></h1>
        </div>
        </Link>
